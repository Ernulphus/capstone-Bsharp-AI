...
instrument_type = "Bagpipes" # First letter capitalized, singular (except Bagpipes)
...
urls = get_images(wd, 0, 200) # Get images using wd, 2nd param is delay, 3rd is number of images to get
...
for i, url in enumerate(urls):
    ...
    download_image("music_instruments_images/Woodwind/" + instrument_type+"/", url, instrument_type + datetime.datetime.now().strftime("%f") + ".jpg")
