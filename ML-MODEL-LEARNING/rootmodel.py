...
instruments_data = tf.keras.utils.image_dataset_from_directory('../music_instruments_images/', labels= 'inferred', batch_size=1, image_size=(width, width))
...
class_names = ['Brass', 'Percussion', 'Strings', 'Woodwind']
...
pickle.dump(model, open('rootmodel.pkl','wb'))
