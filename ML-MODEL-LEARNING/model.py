...
instruments_data = tf.keras.utils.image_dataset_from_directory('/root/capstone-Bsharp-AI/music_instruments_images/Brass/', labels= 'inferred')
...
# validation data#
validation_data = tf.keras.utils.image_dataset_from_directory('/root/capstone-Bsharp-AI/validation_images/Brass/', labels= 'inferred', batch_size= None)
